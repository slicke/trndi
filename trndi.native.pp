...
begin
  ...
  // Tomt => �terst�ll tray-ikonen fr�n Application.Icon
  if Value = '' then
  begin
  ...
  // Basikon: Application.Icon (enkel och stabil bas varje g�ng)
  ...
  try
    ...
    // Badge-rektangel (nere till h�ger)
    BadgeRect := Rect(W - BadgeSize, H - BadgeSize, W, H);

    // Textf�rg utifr�n bakgrundens luminans
    ...
    begin
      ...
      Bmp.Canvas.RoundRect(BadgeRect.Left, BadgeRect.Top, BadgeRect.Right, BadgeRect.Bottom,
                           Radius*2, Radius*2);
      // Liten \u201cfyrkant\u201d i nederh�rnet f�r tydlighet
